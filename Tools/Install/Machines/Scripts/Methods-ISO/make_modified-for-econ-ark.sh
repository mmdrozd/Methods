...
ditto "$scriptDir/start_modified-for-$myuser-make.sh" "$econarktools/$ISOmaker/start.sh"
ditto "$scriptDir/finish_modified-for-$myuser-make.sh" "$econarktools/$ISOmaker/finish.sh"
