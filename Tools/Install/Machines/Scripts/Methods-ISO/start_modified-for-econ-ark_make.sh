...
echo "sudo chmod a+x /home/$myuser/.bashrc_aliases"
echo "sudo chown $myuser:$myuser /home/$myuser/.bashrc_aliases"
echo "sudo -u $myuser xfce4-terminal -e 'bash -c -i /home/$myuser/.bashrc_aliases &'" >> "$start" # Execute the new bashrc to start the log
